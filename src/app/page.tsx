...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white antialiased overflow-x-hidden">
      ...
      {/* Header */}
      <header
        className={`fixed w-full top-0 left-0 right-0 z-40 transition-all duration-300 ${
          scrolled
            ? "bg-slate-950/80 backdrop-blur-lg border-b border-slate-800/40 shadow-sm"
            : "bg-transparent"
        }`}
      >
        <div className="container mx-auto px-4 md:px-6 py-3">
          ...
          {/* Mobile Nav Overlay */}
{isMenuOpen && (
  // overlay covers entire viewport so underlying hero does not show through
  <div
  ...
  >
    ...
    {/* panel */}
    <nav className="relative z-10 max-w-md w-full h-full bg-transparent">
      <div className="flex flex-col h-full p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-cyan-500 flex items-center justify-center text-white font-bold">CB</div>
            <div>
              <div className="text-base font-semibold">Chirantan Bramhachari</div>
        ...
        <div className="flex-1 space-y-4">
          {["About", "Experience", "Projects", "Contact"].map((item) => (
            <a
              ...
              href={`#${item.toLowerCase()}`}
              onClick={() => setIsMenuOpen(false)}
              className="block text-lg font-medium text-gray-100 hover:text-white py-3 px-2 rounded-md"
            >
              {item}
            </a>
          ))}
        ...
        <div className="mt-6">
          <a
            href="/Chirantan_Bramhachari_Resume.pdf"
            download
            className="block w-full text-center px-4 py-3 rounded-full bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-medium"
            onClick={() => setIsMenuOpen(false)}
          >
            Download Resume
          </a>
      ...
      <main className="relative">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-2xl">
                    ...
                    experiences with React, Next.js, and Laravel. Turning ideas
                    into elegant code.
                  </p>
                </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-slate-700/40">
              <p className="text-base md:text-lg text-gray-300 leading-relaxed">
                ...
                problems into elegant solutions. With expertise in React,
                Next.js, and Laravel, I build responsive and performant web
                applications that deliver exceptional user experiences. My
                approach combines clean code practices, modern toolchains, and a
                keen eye for design.
              </p>

              <p className="text-base md:text-lg text-gray-300 leading-relaxed mt-4">
                I graduated with a BCA (CGPA: 8.6) and have gained real-world
                experience through internships and full-time development work.
        ...
        <section
          id="experience"
          className="py-20 px-4 bg-gradient-to-b from-transparent to-slate-950/60"
        >
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  points: [
                    "Gathered client requirements and coordinated between technical and business teams",
                  ],
                },
              ].map((job, i) => (
                <article
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    ...
                    <div className="flex flex-wrap gap-2 items-center">
                      {job.tags.map((t) => (
                        <span
                          key={t}
                          className="px-2 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-xs text-purple-200"
                        >
                          {t}
                        </span>
                      ))}
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
              {[
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${project.gradient} opacity-0 group-hover:opacity-8 rounded-3xl -z-10`}
                  />
                  <div className="relative">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 grid-cols-1 lg:grid-cols-2 items-start">
                  ...
                  {[
                    {
                      icon: Mail,
                      label: "Email",
                      value: "chirantanbramhacharimia2@gmail.com",
                      href: "mailto:chirantanbramhacharimia2@gmail.com",
                    },
                    {
                      icon: Phone,
                      label: "Phone",
                      value: "+91-9064469835",
                      href: "tel:+919064469835",
                    },
                    {
                      icon: Linkedin,
                      label: "LinkedIn",
                      value: "Connect with me",
                      href: "https://www.linkedin.com/in/chirantan-bramhachari-93682127a/",
                    },
                  ].map((c, i) => (
                    <a
                      key={i}
              ...
              <form
                ...
                className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm p-6 rounded-3xl border border-slate-700/40"
              >
                <div className="space-y-4">
                  <input
                    required
      ...
      <footer className="py-10 border-t border-slate-800/40">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Chirantan Bramhachari. Crafted with
            passion.
          </p>
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 rounded-lg bg-slate-800/30 border border-slate-700/40"
            >
